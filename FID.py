...
# 150.61842751763265
# **** anger ****
# images1 (67, 112, 112, 3)      images2 (67, 112, 112, 3)
# 65.18192175406006
# **** contempt ****
# images1 (1000, 112, 112, 3)      images2 (1000, 112, 112, 3)
# 12.155819860442676
...
if __name__ == "__main__":
    ...
    parser = OptionParser()
    parser.add_option("--p1", "--path1", dest="path1", default='datasets/dataFile_1001/processed/EmotioNet_aligned', 
                      help="Path to directory containing the real images")
    parser.add_option("--p2", "--path2", dest="path2", default='datasets/dataFile_1014o/processed/EmotioNet_aligned', 
    ...
    images1_dict , images2_dict = {} , {} 
    for emotion in emolist:
        print("****",emotion,"****")
        if emotion not in images1_dict.keys():
