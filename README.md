...
e9 | [PyTorch] [models_gan_pytorch_4.py.regress](models_gan_pytorch_4.py.regress) , [train_gan_pytorch_4.py.regress](train_gan_pytorch_4.py.regress)  | Same as e8 with conditional regression loss|  confirmed hypothesis in report, i.e. OpenFace annotations for AU intensity are less reliable than OpenFace annotations for AU presence   |
